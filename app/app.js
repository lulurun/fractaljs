(function (global, factory) {
  ...
  function define$1(name, props, base) {
  ...
  var template$2 = "<h3>Examples</h3>\n<ul>\n{{#.}}\n<li>\n<a href=\"{{href}}\">{{name}}</a>\n</li>\n{{/.}}\n</ul>\n\n";

  var main = F.component('main', {
    DefaultComponent: 'list'
  }, F.Router);

  var examples = ["markdown", "button"];

  var list = F.component('list', {
    template: template$2,
    data: examples.map(function (v) {
